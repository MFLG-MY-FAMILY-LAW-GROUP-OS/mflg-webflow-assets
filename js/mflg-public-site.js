(function () {
  ...
  function hero(title, copy, actions) {
    return `<section class="hero">
      <video class="hero-video" autoplay muted loop playsinline preload="auto" poster="/assets/images/mflg-hero-family-poster.jpg?v=mflg-live-20260613-maplabel1">
  ...
  function about() {
    return section("About", "A focused Arizona family-law practice built around clear intake, practical document help, and licensed legal paraprofessional support within scope.", `<div class="about-profile">
      <div class="about-profile-copy">
        ...
        <div class="about-profile-media"><img src="/assets/images/jeremy-profile.jpeg?v=mflg-live-20260613-maplabel1" alt="Jeremy James Jack JD, LP"></div>
