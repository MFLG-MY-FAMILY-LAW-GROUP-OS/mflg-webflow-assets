...
- Current `mflg-public-website` deployment: `70af2631-1edb-4e6b-962b-4d59afd9cdc7`
- Current `mflg-webflow-assets` deployment: `50803fd3-bbf3-4e82-91c3-7095d4a651d9`
- Rollback `mflg-public-website` deployment: `69d74ec7-9bdf-4541-ac0e-1623b600180c`
- Rollback `mflg-webflow-assets` deployment: `9f68e859-f076-4cee-8362-1a078f3dfbd8`
...
- Source-label status: the prior live deployment was reported as `main / 778f63e` while the verified prior release tag peeled to `95ac303ffa561636c76ce1e549934cd18ec86552`. The new Cloudflare production deployments show `main / 2810c38`, created from the clean durable checkout above.
